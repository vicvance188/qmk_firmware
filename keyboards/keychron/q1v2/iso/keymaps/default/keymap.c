...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [WIN_FN] = LAYOUT_iso_83(
        _______,  NK_TOGG,  RM_TOGG,  RM_PREV,  RM_NEXT,  RM_VALD,  RM_VALU,  RM_HUED,  RM_HUEU,  RM_SATD,  RM_SATU,  RM_SPDD,    RM_SPDU,  KC_SLEP,            KC_PAUS,
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  _______,    _______,  _______,            KC_END,
